...
class AgeVC: UIViewController {
    ...
    */
    @IBAction func camer(_ sender: UIButton)
    {
    ...
    @IBAction func video(_ sender: UIButton)
    {
        ...
        actionsheet.addAction(UIAlertAction(title: "Front Camera", style: .default, handler: { (action:UIAlertAction)in
            ...
            let foo = self.storyboard?.instantiateViewController(withIdentifier: "FrontAgeVC") as! FrontAgeVC
        ...
        actionsheet.addAction(UIAlertAction(title: "Back Camera", style: .default, handler: { (action:UIAlertAction)in
            ...
            let foo = self.storyboard?.instantiateViewController(withIdentifier: "BackAgeVC") as! BackAgeVC
...
extension AgeVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension AgeVC {
    ...
    func detectAge(image: CIImage) {
        ...
        let request = VNCoreMLRequest(model: model) { [weak self] request, error in
            ...
            DispatchQueue.main.async { [weak self] in
                ...
                self?.lblname.text = "Classification:\n" + descriptions.joined(separator: "\n")
            }
        }
    ...
    fileprivate func handleDetection(request: VNRequest, errror: Error?) {
        DispatchQueue.main.async { [weak self] in
            ...
            guard let ciImage = CIImage(image: self!.ciii) else {
                fatalError("couldn't convert UIImage to CIImage")
            }
